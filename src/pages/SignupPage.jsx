  ...
  return (
    <div className="min-h-screen bg-surface-dark flex items-center justify-center px-4">
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-1/3 left-1/4 w-80 h-80 bg-brand-800/10 rounded-full blur-3xl" />
      </div>
      ...
      <div className="w-full max-w-md relative z-10 animate-fade-in">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 mt-2 text-sm">Start your learning journey</p>
        </div>
        ...
        <div className="glass-card p-8">
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs text-gray-500">
              <span className="bg-surface-card px-3">or create with email</span>
            </div>
          </div>
