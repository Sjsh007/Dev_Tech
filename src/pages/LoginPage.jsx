  ...
  return (
    <div className="min-h-screen bg-surface-dark flex items-center justify-center px-4">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-brand-800/10 rounded-full blur-3xl" />
      </div>
      ...
      <div className="w-full max-w-md relative z-10 animate-fade-in">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white">Welcome to RUE</h1>
          <p className="text-gray-400 mt-2 text-sm">Recursive Understanding Engine</p>
        </div>
        ...
        <div className="glass-card p-8">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-white/5 hover:bg-white/10 
                       border border-surface-border hover:border-white/30 rounded-xl text-white font-medium
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs text-gray-500">
              <span className="bg-surface-card px-3">or sign in with email</span>
            </div>
          </div>
